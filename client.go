...
type Client struct {
	*http.Client
	...
	// Overrides
	Endpoints map[core.Endpoint]string
...
func (c *Client) Request(operation core.Operation) (req *http.Request, err error) {
...
func (c *Client) buildJSONRequest(operation core.Operation) (*http.Request, error) {
...
func (c *Client) setRequestHeaders(req *http.Request, desc *core.Description) error {
...
func (c *Client) Do(result interface{}, operation core.Operation) error {
