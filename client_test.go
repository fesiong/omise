...
func TestClient_Request(t *testing.T) {
	...
	client.Endpoints[core.API] = "http://api.omise.dev:3000"
	client.Endpoints[core.Vault] = "http://vault.omise.dev:4500"
...
func TestClient_Error(t *testing.T) {
	...
	err = client.Do(nil, &core.Description{
		Endpoint: core.API,
		Method:   "GET",
	...
	err = client.Do(nil, &core.Description{
		Endpoint: core.Endpoint("virus_endpoint"),
		Method:   "GET",
		Path:     "/",
	})
	r.NotNil(t, err)
...
func TestClient_TransportError(t *testing.T) {
	...
	err := client.Do(&struct{}{}, &core.Description{
		Endpoint: core.API,
		Method:   "GET",
		Path:     "/malformed",
	})
