...
func (req *ListCards) Describe() *core.Description {
...
// }
//
// func (req *CreateCard) Description() *core.Description {
// 	return &core.Description{core.API, "PATCH", "/customers/" + req.CustomerID, nil}
// }
...
func (req *RetrieveCard) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *UpdateCard) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "PATCH",
		Path:        "/customers/" + req.CustomerID + "/cards/" + req.CardID,
...
func (req *DestroyCard) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "DELETE",
		Path:        "/customers/" + req.CustomerID + "/cards/" + req.CardID,
