...
func (req *ListCharges) Describe() *core.Description {
...
func (req *CreateCharge) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
		Path:        "/charges",
...
func (req *UpdateCharge) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "PATCH",
...
func (req *RetrieveCharge) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
		Path:        "/charges/" + req.ChargeID,
...
func (req *CaptureCharge) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
...
func (req *ReverseCharge) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
