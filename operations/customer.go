...
func (req *ListCustomers) Describe() *core.Description {
...
func (req *CreateCustomer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
		Path:        "/customers",
...
func (req *RetrieveCustomer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *UpdateCustomer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "PATCH",
		Path:        "/customers/" + req.CustomerID,
...
func (req *DestroyCustomer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "DELETE",
		Path:        "/customers/" + req.CustomerID,
...
func (req *ListCustomerChargeSchedules) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
