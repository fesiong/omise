...
func (req *ListRecipients) Describe() *core.Description {
...
func (req *CreateRecipient) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
		Path:        "/recipients",
...
func (req *RetrieveRecipient) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *UpdateRecipient) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "PATCH",
		Path:        "/recipients/" + req.RecipientID,
...
func (req *DestroyRecipient) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "DELETE",
		Path:        "/recipients/" + req.RecipientID,
...
func (req *ListRecipientTransferSchedules) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
