...
import (
	...
	"github.com/fesiong/omise/schedule"
)
...
func (req *CreateChargeSchedule) Describe() *core.Description {
...
func (req *CreateTransferSchedule) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
		Path:        "/schedules",
...
func (req *ListSchedules) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
		Path:        "/schedules",
...
func (req *ListScheduleOccurrences) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *ListChargeSchedules) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *ListTransferSchedules) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *RetrieveSchedule) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *DestroySchedule) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "DELETE",
		Path:        "/schedules/" + req.ScheduleID,
