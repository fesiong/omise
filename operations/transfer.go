...
func (req *ListTransfers) Describe() *core.Description {
...
func (req *CreateTransfer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "POST",
		Path:        "/transfers",
...
func (req *RetrieveTransfer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "GET",
...
func (req *UpdateTransfer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "PATCH",
		Path:        "/transfers/" + req.TransferID,
...
func (req *DestroyTransfer) Describe() *core.Description {
	return &core.Description{
		Endpoint:    core.API,
		Method:      "DELETE",
		Path:        "/transfers/" + req.TransferID,
